...
/**
 * Step definitions runner for 'Headlines are listed' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class, sdk = [28])
@MediumTest
class HeadlinesListedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        start(HeadlinesListedSteps(testApp.getMockWebServer()))
    }
