...
/**
 * Step definitions runner for 'News listed article shared' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class, sdk = [28])
@MediumTest
class ShareListedArticleStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@listed-article-shared")
                .scenarios()
    ...
    fun test() {
        ...
        start(ShareListedArticleSteps(testApp.getMockWebServer()))
    }
