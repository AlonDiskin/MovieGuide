...
/**
 * Step definitions runner for 'User bookmark article' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class BookmarkArticleStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        hiltRule.inject()
        start(BookmarkArticleSteps(mockWebServer,testDatabase))
    }
