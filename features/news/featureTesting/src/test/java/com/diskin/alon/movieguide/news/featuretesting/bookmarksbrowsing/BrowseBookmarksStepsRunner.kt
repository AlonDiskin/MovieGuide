...
/**
 * Step definitions runner for 'User browse bookmarked news' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class, sdk = [28])
@MediumTest
class BrowseBookmarksStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
