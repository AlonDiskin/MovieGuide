...
/**
 * Step definitions runner for 'Movie news article shared' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class, sdk = [28])
@MediumTest
class ArticleSharedStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        start(ArticleSharedSteps(testApp.getMockWebServer()))
    }
