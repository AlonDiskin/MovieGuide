...
/**
 * Step definitions runner for 'Article reading error handling' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class, sdk = [28])
@MediumTest
class ArticleReadingFailStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                .withFeatureFromAssets("feature/articles_browsing.feature")
                .withTags("@article-reading-errors")
                .scenarios()
    ...
    fun test() {
        ...
        start(ArticleReadingFailSteps(testApp.getMockWebServer()))
    }
