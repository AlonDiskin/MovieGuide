...
/**
 * Step definitions runner for 'User share bookmark' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class ShareBookmarkStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        hiltRule.inject()
        start(ShareBookmarkSteps(mockWebServer, testDatabase))
    }
