...
/**
 * Step definitions runner for 'User read bookmarked article' scenario.
 */
@HiltAndroidTest
...
@MediumTest
class ReadBookmarkStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        hiltRule.inject()
        start(ReadBookmarkSteps(mockWebServer,testDatabase))
    }
