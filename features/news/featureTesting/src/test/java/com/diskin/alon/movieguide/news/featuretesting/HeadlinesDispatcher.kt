...
import com.diskin.alon.movieguide.news.data.*
...
class HeadlinesDispatcher : Dispatcher() {
    ...
    private var pageSources = Pair("feed_init_page.json","feed_last_page.json")
    ...
    fun refresh() {
        pageSources = Pair("refresh_feed_init_page.json", "refresh_feed_last_page.json")
    }
}