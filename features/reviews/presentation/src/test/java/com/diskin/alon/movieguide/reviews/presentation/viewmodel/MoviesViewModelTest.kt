...
/**
 * [MoviesViewModel] unit test class.
 */
class MoviesViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = MoviesViewModel(getMoviesUseCase,pagingMapper,savedState)
    }
    ...
    fun initSelectedSortingStateAsSavedWhenCreatedWithSavedSortingState() {
        ...
        viewModel = MoviesViewModel(getMoviesUseCase,pagingMapper,savedStateHandle)
