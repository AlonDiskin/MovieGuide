...
class MovieReviewViewModel @Inject constructor(
    @MovieReviewModelDispatcher private val model: Model,
    ...
    val movieReview: LiveData<MovieReview> get() = _modelReview
    private val _reviewUpdate = MutableLiveData<UpdateViewData>(UpdateViewData.Update)
    val reviewUpdate: LiveData<UpdateViewData> get() = _reviewUpdate
    private val _reviewError =  MutableLiveData<ErrorViewData>()
    val reviewError: LiveData<ErrorViewData> get() = _reviewError
