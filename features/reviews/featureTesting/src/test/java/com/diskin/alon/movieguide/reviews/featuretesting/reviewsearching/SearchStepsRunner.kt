...
/**
 * Step definitions runner for 'User search for movies' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class,sdk = [28])
@MediumTest
class SearchStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    fun test() {
        ...
        start(SearchSteps(testApp.getMockWebServer()))
    }
