...
/**
 * Step definitions runner for 'Reviews listing browsing errors handling' scenario.
 */
@RunWith(ParameterizedRobolectricTestRunner::class)
@LooperMode(LooperMode.Mode.PAUSED)
@Config(application = TestApp::class,sdk = [28])
@MediumTest
class MoviesListedErrorStepsRunner(scenario: ScenarioConfig) : GreenCoffeeTest(scenario) {
    ...
    companion object {
        ...
        fun data(): Collection<Array<Any>> {
            ...
            val scenarioConfigs = GreenCoffeeConfig()
                ...
                .withTags("@reviews-listed-errors")
                .scenarios()
    ...
    fun test() {
        ...
        start(MoviesListedErrorSteps(testApp.getMockWebServer()))
    }
